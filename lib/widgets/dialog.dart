...
class AlertBox {
  ...
  //     case AnimationTransition.fromRight:
  //       return AnimationTransition.fromRight(
  //           animation, secondaryAnimation, child);
  //     case AnimationTransition.fromLeft:
  //       return AnimationTransition.fromLeft(
  //           animation, secondaryAnimation, child);
  //     case AnimationTransition.fromBottom:
  //       return AnimationTransition.fromBottom(
  //           animation, secondaryAnimation, child);
  //     case AnimationTransition.grow:
  //       return AnimationTransition.grow(animation, secondaryAnimation, child);
  //     case AnimationTransition.shrink:
